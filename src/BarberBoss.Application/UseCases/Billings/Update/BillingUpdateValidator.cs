...
public class BillingUpdateValidator : AbstractValidator<RequestUpdateExpenseJson>
{
    public BillingUpdateValidator()
    {
        ...
        RuleFor(billing => billing.Status).IsInEnum().WithMessage(ResourceErrorMessages.PAYMENT_STATUS_INVALID);
